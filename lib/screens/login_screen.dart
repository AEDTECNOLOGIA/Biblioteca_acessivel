...
import 'package:app_de_leituraa/screens/forgot_password_screen.dart';
import 'package:app_de_leituraa/screens/sign_up_screen.dart';
  ...
  void _login() {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Tentando login com $email...')),
      );
    }
  }
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                            borderSide: const BorderSide(color: Color(0xFF8A61A9)),
                          ),
                        ),
