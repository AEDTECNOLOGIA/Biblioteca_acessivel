...
import 'package:app_de_leituraa/screens/login_screen.dart'; // Adicionado para navegação para LoginScreen
...
class _SplashScreenState extends State<SplashScreen>
  ...
  // Modificado para usar MaterialPageRoute
  void _navigateToNextScreen(BuildContext context) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const LoginScreen(userType: 'responsável')),
    );
  }
